...
DELETE FROM post_comment WHERE is_delete=TRUE;
...
FROM post AS p
WHERE p.comment_tree_id IS NULL;

-- comment_tree 生成
INSERT INTO comment_tree(id,comment_total,group_type) SELECT comment_tree_id,comment_num,'post' FROM _tree_map;
